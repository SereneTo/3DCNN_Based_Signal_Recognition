...
save('TrainingSet/trainingData','trainingData','-v7.3');
save('TrainingSet/trainingLabel','trainingLabel','-v7.3');
...
save('TrainingSet/testingData','testingData','-v7.3');
save('TrainingSet/testingLabel','testingLabel','-v7.3');
fprintf("finish!");